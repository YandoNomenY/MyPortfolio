...
const projects = [
    ...
    {
        id: 2,
        title: " Yazara Social Network",
        description: "Social Network homepage app",
    ...
    {
        id: 3,
        title: "Dashboard of Yazara administration",
        description: " Yzara Dashboard app",
...
export const ProjectsSection = () => {
    return (
        <div className="py-24 px-4 relative" id="projects">
                            ...
                            <div className="p-6">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag) => (
                                        <span className="px-2 py-1 border text-xs font-medium rounded-full bg-secondary-foreground">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
